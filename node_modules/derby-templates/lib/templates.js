...
ParentWrapper.prototype.dependencies = function(context, forInnerPath) {
  var deps = (this.expression || this.template).dependencies(context.forViewParent(), forInnerPath);
  // console.trace('ParentWrapper deps', deps, (this.expression || this.template).serialize());
  return deps;
};
