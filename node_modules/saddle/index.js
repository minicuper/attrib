...
AttributesExpression.prototype.getBound = function(context, element, key, elementNs) {
  console.trace('AttributesExpression - getBound')
  this.elementNs = elementNs;
...
AttributesExpression.prototype.update = function(context, binding) {
  console.trace('AttributesExpression - update')
  var value = this.get(context);
  var element = binding.element;
...
function ComponentAttribute(component, name, expression, ns) {
  // In attributes, expression may be an instance of Template or Expression
...
ComponentAttribute.prototype = new Attribute();
ComponentAttribute.prototype.get = function(context) {
  return getUnescapedValue(this.expression, context);
};
ComponentAttribute.prototype.getBound = function(context, element, name) {
  context.addBinding(new AttributeBinding(this, context, element, name));
  return getUnescapedValue(this.expression, context);
};
...
ComponentAttribute.prototype.update = function(context, binding) {
  var value = getUnescapedValue(this.expression, context);
  console.log('value', name, value, typeof value)
  this.component.model.setDiffDeep(this.name, value);
};
